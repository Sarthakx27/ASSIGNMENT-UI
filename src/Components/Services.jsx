  ...
  return (
    <div className="font-display w-5/6 mx-auto flex flex-col justify-center text-center items-center pt-6 md:pt-20 lg:pt-20">
      ...
      <div className="grid grid-cols-2 md:grid-cols-2 lg:grid-cols-3 lg:grid-rows-2 gap-3 md:gap-16 lg:gap-16 mt-8 md:mt-20 lg:mt-20">
        <div className="group flex flex-col border-2 rounded-3xl justify-center items-center px-5 py-7 md:px-16 md:py-10 lg:px-16 lg:py-14 hover:bg-violet-400 duration-500">
        ...
        <div className="group flex flex-col border-2 rounded-3xl justify-center items-center px-5 py-7 md:px-16 md:py-10 lg:px-16 lg:py-14 hover:bg-green-400 duration-500">
        ...
        <div className="group flex flex-col border-2 rounded-3xl justify-center items-center px-5 py-7 md:px-16 md:py-10 lg:px-16 lg:py-14 hover:bg-cyan-400 duration-500">
        ...
        <div className="group flex flex-col border-2 rounded-3xl justify-center items-center px-5 py-7 md:px-16 md:py-10 lg:px-16 lg:py-14 hover:bg-orange-400 duration-500">
        ...
        <div className="group flex flex-col border-2 rounded-3xl justify-center items-center px-5 py-7 md:px-16 md:py-10 lg:px-16 lg:py-14 hover:bg-blue-500 duration-500">
        ...
        <div className="group flex flex-col border-2 rounded-3xl justify-center items-center px-5 py-7 md:px-16 md:py-10 lg:px-16 lg:py-14 hover:bg-gray-500 duration-500">
